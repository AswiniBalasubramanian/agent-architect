...
export const personas: Persona[] = [
  {
    ...
    routes: ["/", "/processes", "/requirements", "/test-cases", "/scenarios", "/plans", "/runs", "/defects"],
  ...
  },
  {
    ...
    routes: ["/", "/processes", "/requirements", "/test-cases", "/scenarios", "/plans", "/runs", "/defects", "/admin"],
